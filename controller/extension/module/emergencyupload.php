...
class Controllerextensionmoduleemergencyupload extends Controller {
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			$data['marketings'][] = array(
				...
				'edit'         => $this->url->link('extension/module/emergencyupload/edit', 'user_token=' . $this->session->data['user_token'] . '&marketing_id=' . $result['marketing_id'] . $url, true)
			);
		}
	...
	protected function validateForm() {
		...
		$marketing_info = $this->model_extension_module_emergencyupload->getMarketingByCode($this->request->post['code']);
