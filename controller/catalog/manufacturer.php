	...
	protected function getList() {
		...
		foreach ($results as $result) {
			$data['manufacturers'][] = array(
				...
				'edit'            => $this->url->link('catalog/manufacturer/edit', 'user_token=' . $this->session->data['user_token'] . '&news_id=' . $result['news_id'] . $url, true)
			);
		}
...
/*
		if ((utf8_strlen($this->request->post['news_id']) < 1) || (utf8_strlen($this->request->post['news_id']) > 64)) {
