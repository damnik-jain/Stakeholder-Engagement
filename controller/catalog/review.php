...
class ControllerCatalogReview extends Controller {
	...
	protected function getList() {
		...
		$this->load->language('catalog/reviewdetails');
		...
		foreach ($results as $result) {
			$data['reviews'][] = array(
				...
				'responses'       => $this->url->link('catalog/review/responses', 'user_token=' . $this->session->data['user_token'] . '&review_id=' . $result['survey_id'] . $url, true)
			);
		}
	...
	public function responses()
	{
		...
		$this->load->language('catalog/review_details');
		...
		$review_total = $this->model_catalog_review->getTotalDetails($filter_data, $this->request->get['review_id']);

		$results = $this->model_catalog_review->getDetails($filter_data, $this->request->get['review_id']);
		...
		$this->response->setOutput($this->load->view('catalog/review_listdetails', $data));
