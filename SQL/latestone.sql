...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 24, 2018 at 08:50 PM
...
--
-- Table structure for table `oc_all_cities`
--

CREATE TABLE `oc_all_cities` (
  `ID` int(10) NOT NULL,
  `city_name` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `oc_all_cities`
--

INSERT INTO `oc_all_cities` (`ID`, `city_name`) VALUES
(2, 'CIty2'),
(3, 'City3'),
(4, 'CIty4'),
(1, 'Mumbai');
...
(1, 'Default', '', 1, '2018-03-21 15:51:31', '2018-03-21 15:51:31');
...
(1, 1, 'e514901f9c847aa190ebfe4356', '::1', '2018-03-24 14:45:48', '2018-03-24 14:45:48'),
(2, 1, '1f5b86279933b12888e305a481', '::1', '2018-03-24 18:00:05', '2018-03-24 18:00:05'),
(3, 1, '88ffcb9f2bdbe2784e398bcdfd', '::1', '2018-03-24 18:00:12', '2018-03-24 18:00:12');
...
(2, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, '2018-03-24 19:47:28'),
...
(1, 1, 0, 1, 'Ira', 'Kawthalkar', 'irakawthalkar21@gmail.com', '68764342487875', '', 'ed9fbd08b020b293e91dca5d1351a2fc87898ab0', 'n9Z5lZ6XU', NULL, NULL, 1, 0, '', '::1', 1, 0, '', '', '2018-03-21 15:54:37');
...
INSERT INTO `oc_manufacturer` (`news_id`, `name`, `date`, `image`) VALUES
(1, 'Road Transport Tender Obtained', '2018-03-21', NULL),
(2, 'Waste Management Funding Next Stage', '2018-03-21', NULL);
...
(1, 'Floods', 'Floods in mumbai metro is very dangerous. Help Help Help', '5ab64304052cd', 0, '2018-03-24 17:52:57');
...
CREATE TABLE `oc_news` (
  ...
  `news_topic` varchar(500) NOT NULL,
...
--
-- Table structure for table `oc_project_news`
--

CREATE TABLE `oc_project_news` (
  `news_id` int(11) NOT NULL,
  `project_id` int(11) NOT NULL,
  `date` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  `time` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  `headline` varchar(500) COLLATE utf8_unicode_ci DEFAULT NULL,
  `description` varchar(2000) COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `oc_project_news`
--

INSERT INTO `oc_project_news` (`news_id`, `project_id`, `date`, `time`, `headline`, `description`) VALUES
(1, 1, '21-03-2018', '10:27 AM', 'Project Undergoing Review by Experts', 'DEscr'),
(2, 1, '22-03-2018', '10:30 AM', 'Tenders and Applications are now open', 'this is description'),
(3, 1, '23-03-2018', '10:53 AM', 'Chief Minister invites Reliance Infra Pvt.Ltd to engage in Urban Planning', 'DESC\r\n');
...
INSERT INTO `oc_seo_url` (`seo_url_id`, `language_id`, `query`, `keyword`) VALUES
...
('1f5b86279933b12888e305a481', '{"api_id":"1"}', '2018-03-24 12:54:06'),
('2b153f264570f399c030516df1', '{"user_id":"1","user_token":"orIzcufk8i6ljfb4PRMkl3kXO6gyVNdT"}', '2018-03-24 00:54:48'),
('80879e865d4ce3a8f599fa55d7', '{"user_id":"1","user_token":"2opZBDVyhjR2kQW32bytMbRjxTGPkB9C"}', '2018-03-23 16:37:45'),
('88ffcb9f2bdbe2784e398bcdfd', '{"api_id":"1"}', '2018-03-24 12:54:13'),
('9810b1b3eaceeae391d53cc0f4', '{"user_id":"1","user_token":"8Fc7qJqggxb00YdzyRDTyBQ8kF5XyuXE"}', '2018-03-24 16:00:36'),
('98ff7ed9d0a2fc341452640754', '{"user_id":"1","user_token":"cLSb9RajYmu1thLN9JWE0izkxqX02iqD"}', '2018-03-24 12:39:29'),
('a4903ba8289307b0b934bd580f', '{"user_id":"1","user_token":"Kdm0u2PKUWdEpZ51TYADMUFaeEJxPv58"}', '2018-03-24 10:59:13'),
('b123df1190e1761f2ce973f860', '{"user_id":"1","user_token":"IvJ1aVsybL3rq84Zhf0azWLOaCG26PWS"}', '2018-03-24 20:11:28'),
('bc6e3bd7b12183e4a96c467724', '{"user_id":"1","user_token":"XMFLhix8Hsx2rIdD2KYNXP1YBZWfsxCb"}', '2018-03-23 15:11:53'),
('d5e94be8e78ae6743e1fbe161b', '{"user_id":"1","user_token":"LhWoZomRKUUYQQsqF0VhcKDImKvZY97F"}', '2018-03-24 12:12:51'),
('d895a026b885fd350e8af2a988', '{"user_id":"1","user_token":"LJMcAerUIRzGlKur4u0do0TAoGSW7fmT","language":"en-gb","currency":"USD","customer_id":"1"}', '2018-03-21 16:06:10'),
('e514901f9c847aa190ebfe4356', '{"api_id":"1"}', '2018-03-24 09:39:49'),
('f53824a8350922d10f12b378c9', '{"user_id":"1","user_token":"cQNuzxotFDKnQFh8rUGnIm6ZSgG8tOJ6"}', '2018-03-24 03:58:45');
...
(283, 0, 'config', 'config_encryption', '', 0),
...
(266, 0, 'config', 'config_icon', 'catalog/city1.png', 0),
(265, 0, 'config', 'config_logo', 'catalog/SmartCityLogo.png', 0),
...
(213, 0, 'config', 'config_email', 'irakawthalkar21@gmail.com', 0),
(212, 0, 'config', 'config_geocode', '', 0),
(211, 0, 'config', 'config_address', 'Smart City', 0),
(210, 0, 'config', 'config_owner', 'Smart City', 0),
(209, 0, 'config', 'config_name', 'Smart City', 0),
(208, 0, 'config', 'config_layout_id', '4', 0),
(207, 0, 'config', 'config_theme', 'default', 0),
(206, 0, 'config', 'config_meta_keyword', '', 0),
(205, 0, 'config', 'config_meta_description', 'Smart City', 0),
(204, 0, 'config', 'config_meta_title', 'Smart City', 0),
...
--
-- Indexes for table `oc_all_cities`
--
ALTER TABLE `oc_all_cities`
  ADD PRIMARY KEY (`ID`),
...
--
-- Indexes for table `oc_project_news`
--
ALTER TABLE `oc_project_news`
  ADD PRIMARY KEY (`news_id`),
  ADD KEY `project_id` (`project_id`);
...
--
-- AUTO_INCREMENT for table `oc_all_cities`
--
ALTER TABLE `oc_all_cities`
...
--
-- AUTO_INCREMENT for table `oc_project_news`
--
ALTER TABLE `oc_project_news`
...
--
-- Constraints for table `oc_project_news`
--
ALTER TABLE `oc_project_news`
  ADD CONSTRAINT `oc_project_news_ibfk_1` FOREIGN KEY (`project_id`) REFERENCES `oc_project` (`project_id`);
